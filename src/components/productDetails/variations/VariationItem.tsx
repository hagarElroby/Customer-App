...
const VariationItem = ({
  ...
  return (
    ...
    items-center justify-between gap-3 ${isSelected ? " border-main bg-lightMain3" : "border-lightBlue1 bg-lightBlue1"}`}
      onClick={onClick}
    >
      <div className="h-12 min-w-20 max-w-20 overflow-hidden flex items-center justify-center">
        <img
      ...
      <div className="flex flex-col gap-1 w-full mt-4">
        {variation.variation.map((va, index) => (
          <div className="flex items-center justify-between" key={index}>
            ...
            <span className="w-16 h-4 p-2 bg-lightMain2 rounded-[50px] flex items-center justify-center text-redText font-medium text-[8px] overflow-hidden whitespace-nowrap">
